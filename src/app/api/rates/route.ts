 ...
 * Sumber (semua gratis, tanpa API key):
 * - USDT/IDR: Binance public ticker → fallback CoinGecko
 * - Emas: gold-api.com (XAU/USD spot) × USDTIDR ÷ 31.1035 (gram per troy oz)
 * Selalu ada fallback konstanta agar UI tidak pernah kosong.
 */
